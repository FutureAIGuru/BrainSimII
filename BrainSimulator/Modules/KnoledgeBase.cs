...
namespace BrainSimulator
{
    public partial class NeuronArray
    {
        ...
        string theInPhrase = "";
        string theOutPhrase = "";
        public void KnowledgeBase(NeuronArea na)
        {
            if (!initialized)
                Initialize();
            initialized = true;
        ...
        private void HandleVisionIn()
        {
            ...
            DeleteThings(500);
            NeuronArea naRectangles = FindAreaByLabel("Rectangles");
        ...
        private void HandleSpeechIn()
        {
            ...
            NeuronArea naSpeechIn = FindAreaByLabel("SpeechIn");
        ...
        void HandleSpeechOut()
        {
            ...
            NeuronArea na = FindAreaByLabel("SpeechOut");
            if (na == null) return;
            int found = -1;
            na.BeginEnum();
        ...
        private void HandleMotion()
        {
            ...
            NeuronArea naTurn = FindAreaByLabel("Move");
        ...
        private void HandleTurning()
        {
            ...
            NeuronArea naTurn = FindAreaByLabel("Turn");
            if (naTurn == null) return;
            if (turnCounter > 0)
            {
                naTurn.GetNeuronAt(1).SetValue(1);

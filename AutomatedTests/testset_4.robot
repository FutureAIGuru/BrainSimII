...
Check Do Modules Resize And Undo Correctly?
	...
	##1		2	   ${1152} 	${746}	${485}	${567}	sized_module_graph				module_graph
	...
	#1		10		${175}	${262}	${485}	${567}	sized_module_move				module_move
	...
	#1		15		${175}	${262}	${485}	${567}	sized_module_ratedecoder		module_ratedecoder
	#1		16	    ${175}	${262}	${485}	${567}	sized_module_ratedecoder2		module_ratedecoder2
	...
	#2		12		${175}	${262}	${485}	${567}	sized_module_turn				module_turn
